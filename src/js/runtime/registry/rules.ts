...
export const rules: Rule[] = [
	...
	},
	{
		...
		values: ['hidden', '-webkit-box', 'vertical', '1']
	},
	{
		layer: 'utilities',
		selector: 'line-clamp-2',
		properties: ['overflow', 'display', '-webkit-box-orient', '-webkit-line-clamp'],
		values: ['hidden', '-webkit-box', 'vertical', '2']
	},
	{
		layer: 'utilities',
		selector: 'line-clamp-3',
		properties: ['overflow', 'display', '-webkit-box-orient', '-webkit-line-clamp'],
		values: ['hidden', '-webkit-box', 'vertical', '3']
	},
	{
		layer: 'utilities',
		selector: 'line-clamp-4',
		properties: ['overflow', 'display', '-webkit-box-orient', '-webkit-line-clamp'],
		values: ['hidden', '-webkit-box', 'vertical', '4']
	},
	{
		layer: 'utilities',
		selector: 'line-clamp-5',
		properties: ['overflow', 'display', '-webkit-box-orient', '-webkit-line-clamp'],
		values: ['hidden', '-webkit-box', 'vertical', '5']
	},
	{
		layer: 'utilities',
		selector: 'line-clamp-6',
		properties: ['overflow', 'display', '-webkit-box-orient', '-webkit-line-clamp'],
		values: ['hidden', '-webkit-box', 'vertical', '6']
	},
	{
		layer: 'utilities',
		selector: 'line-clamp-none',
		properties: ['overflow', 'display', '-webkit-box-orient', '-webkit-line-clamp'],
		values: ['visible', 'block', 'horizontal', 'none']
	},
	{
		layer: 'styles',
		selector: 'aspect',
	...
	},
	{
		...
		values: ['calc(var(--spacing) * var({var}))', 'calc(var(--spacing) * var({var2}))'],
	...
	},
	{
		...
		selector: '[border-spacing-x]',
		properties: ['--tw-border-spacing-x', 'border-spacing'],
		values: ['var({var})', 'var(--tw-border-spacing-x) var(--tw-border-spacing-y)'],
		placeholders: { '{var}': 'border-spacing-x' }
	},
	{
		layer: 'styles',
	...
	},
	{
		...
		values: ['var({var})', 'var({var})', 'var({var})', 'var(--tw-scale-x) var(--tw-scale-y)'],
	...
	},
	{
		...
		values: ['var({var})', 'var(--tw-scale-x) var(--tw-scale-y) var(--tw-scale-z)'],
	...
	},
	{
		...
		selector: '[translate]',
		properties: ['--tw-translate-x', '--tw-translate-y', 'translate'],
		values: ['var({var})', 'var({var})', 'var(--tw-translate-x) var(--tw-translate-y)'],
		placeholders: { '{var}': 'translate' }
	},
	{
		layer: 'styles',
		...
		values: ['calc(var(--spacing) * var({var}))', 'var(--tw-translate-x) var(--tw-translate-y)'],
	...
	},
	{
		...
		selector: '[translate-z]',
		properties: ['--tw-translate-z', 'translate'],
		values: ['var({var})', 'var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)'],
		placeholders: { '{var}': 'translate-z' }
	},
	{
		layer: 'styles',
	...
	},
	{
		layer: 'styles',
		selector: 'via',
		properties: ['--tw-gradient-via', '--tw-gradient-via-stops', '--tw-gradient-stops'],
		values: [
			'var({var})',
	...
	{
		layer: 'utilities',
		selector: 'display-inline-table',
		properties: ['display'],
		values: ['inline-table']
	},
	{
		layer: 'utilities',
		selector: 'display-table-caption',
		properties: ['display'],
		values: ['table-caption']
	},
	{
		layer: 'utilities',
		selector: 'display-table-cell',
		properties: ['display'],
		values: ['table-cell']
	},
	{
		layer: 'utilities',
		selector: 'display-table-column',
		properties: ['display'],
		values: ['table-column']
	},
	{
		layer: 'utilities',
		selector: 'display-table-column-group',
		properties: ['display'],
		values: ['table-column-group']
	},
	{
		layer: 'utilities',
		selector: 'display-table-footer-group',
		properties: ['display'],
		values: ['table-footer-group']
	},
	{
		layer: 'utilities',
		selector: 'display-table-header-group',
		properties: ['display'],
		values: ['table-header-group']
	},
	{
		layer: 'utilities',
		selector: 'display-table-row-group',
		properties: ['display'],
	...
	},
	{
		...
		properties: ['--tw-gradient-position', 'background-image'],
		values: ['to top right in oklab', 'linear-gradient(var(--tw-gradient-stops))']
	},
	{
		layer: 'utilities',
	...
	},
	{
		...
		properties: ['--tw-gradient-position', 'background-image'],
		values: ['to bottom right in oklab', 'linear-gradient(var(--tw-gradient-stops))']
	},
	{
		layer: 'utilities',
	...
	},
	{
		...
		properties: ['--tw-gradient-position', 'background-image'],
		values: ['to bottom left in oklab', 'linear-gradient(var(--tw-gradient-stops))']
	},
	{
		layer: 'utilities',
	...
	},
	{
		...
		properties: ['--tw-gradient-position', 'background-image'],
		values: ['to top left in oklab', 'linear-gradient(var(--tw-gradient-stops))']
	},
	{
		layer: 'utilities',
	...
	},
	{
		...
		selector: 'shadow-sm',
		properties: ['--tw-shadow'],
		values: ['0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color)']
	},
	{
		layer: 'components',
		selector: 'shadow-md',
		properties: ['--tw-shadow'],
		values: ['0 4px 6px -1px var(--tw-shadow-color), 0 2px 4px -2px var(--tw-shadow-color)']
	},
	{
		layer: 'components',
		selector: 'shadow-lg',
		properties: ['--tw-shadow'],
		values: ['0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color)']
	},
	{
		layer: 'components',
		selector: 'shadow-xl',
		properties: ['--tw-shadow'],
		values: ['0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color)']
	},
	{
		layer: 'utilities',
...
// 1. Derive `cc` from utilities and append hardcoded exceptions (e.g., .space-x-reverse :where(& > :not(:last-child)))
export const cc: Set<string> = new Set([
	...rules.filter((rule) => rule.layer === 'utilities').map((rule) => rule.selector),
	'divide-x-reverse',
	'divide-y-reverse'
]);

// 2. Derive `vd` from styles and append hardcoded exceptions
export const vd: Set<string> = new Set([
	...rules
		.filter((rule) => rule.layer === 'styles')
		.flatMap((rule) => (rule.dark ? [rule.selector, `dark:${rule.selector}`] : [rule.selector])),
	'divide-x',
	'[divide-x]',
	'divide-y',
	'[divide-y]',
