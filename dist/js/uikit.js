/*! zUIkit 3.25.17 | https://www.getuikit.com | (c) 2014 - 2026 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('uikit', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.zUIkit = factory());
    ...
    const clsTransition = "z-transition";
    ...
    const clsAnimation = "z-animation";
        ...
        toNodes(element).map(
          (element2) => new Promise((resolve, reject) => {
            ...
            const classes = [
              ...
              origin && `z-transform-origin-${origin}`,
    ...
    function getCoveringElement(target) {
      ...
      for (const position of top ? [0, top] : [0]) {
        ...
        for (const el of document.elementsFromPoint(left + width / 2, position)) {
          ...
          !hasClass(el, "z-togglable-leave") && (hasPosition(el, "fixed") && zIndex(
    ...
    var Margin = {
      ...
      data: {
        margin: "z-margin-small-top",
        firstColumn: "z-first-column"
      },
      observe: [
        mutation({
          options: {
    ...
    const clsLeave = "z-transition-leave";
    const clsEnter = "z-transition-enter";
    ...
    var Togglable = {
      ...
      data: {
        ...
        origin: false,
        transition: "ease",
        clsEnter: "z-togglable-enter",
        clsLeave: "z-togglable-leave"
      },
      computed: {
    ...
    function globalApi(App) {
      ...
      App.extend = function(options) {
        options || (options = {});
        const Super = this;
        const Sub = function zUIkitComponent(options2) {
        ...
        updateNav() {
          ...
          for (const el of this.navItems) {
            ...
            if (isNumeric(cmd)) {
              ...
              toggleClass(button, "z-disabled", !!this.parallax);
    ...
    var Slider = {
      ...
      data: () => ({
        ...
        clsActive: "z-active",
        clsActivated: "",
        clsEnter: "z-slide-enter",
        clsLeave: "z-slide-leave",
        clsSlideActive: "z-slide-active",
        Transitioner: false,
        transitionOptions: {}
      }),
      connected() {
    ...
    var Slideshow = {
      ...
      data: {
        animation: "slide",
        clsActivated: "z-transition-active",
    ...
    var LightboxPanel = {
      ...
      data: () => ({
        ...
        items: [],
        cls: "z-open",
        clsPage: "z-lightbox-page",
        clsFit: "z-lightbox-items-fit",
        clsZoom: "z-lightbox-zoom",
        attrItem: "z-lightbox-item",
        selList: ".z-lightbox-items",
        selClose: ".z-close-large",
        selNav: ".z-lightbox-thumbnav, .z-lightbox-dotnav",
        selCaption: ".z-lightbox-caption",
        selCounter: ".z-lightbox-counter",
        pauseOnHover: false,
        velocity: 2,
        Animations,
        template: `<div class="z-lightbox z-overflow-hidden">  <div class="z-lightbox-items"></div>  <div class="z-position-top-right z-position-small z-transition-fade" z-inverse>  <button class="z-lightbox-close z-close-large" type="button" z-close></button>  </div>  <div class="z-lightbox-slidenav z-position-center-left z-position-medium z-transition-fade" z-inverse>  <a href z-slidenav-previous z-lightbox-item="previous"></a>  </div>  <div class="z-lightbox-slidenav z-position-center-right z-position-medium z-transition-fade" z-inverse>  <a href z-slidenav-next z-lightbox-item="next"></a>  </div>  <div class="z-position-center-right z-position-medium z-transition-fade" z-inverse style="max-height: 90vh; overflow: auto;">  <ul class="z-lightbox-thumbnav z-lightbox-thumbnav-vertical z-thumbnav z-thumbnav-vertical"></ul>  <ul class="z-lightbox-dotnav z-dotnav z-dotnav-vertical"></ul>  </div>  <div class="z-lightbox-counter z-text-large z-position-top-left z-position-small z-transition-fade" z-inverse></div>  <div class="z-lightbox-caption z-position-bottom z-text-center z-transition-slide-bottom z-transition-opaque"></div>  </div>`
      }),
      created() {
        ...
        remove$1($$(this.selNav, $el).filter((el) => !matches(el, `.z-${navType}`)));
        for (const [i, item] of this.items.entries()) {
          append(list, "<div>");
          if (navType === "thumbnav") {
            wrapAll(
              toThumbnavItem(item, this.videoAutoplay),
              append($(this.selNav, $el), `<li z-lightbox-item="${i}"><a href></a></li>`)
            );
          }
        }
        if (!this.slidenav) {
          remove$1($$(".z-lightbox-slidenav", $el));
        }
        if (!this.counter) {
          remove$1($(this.selCounter, $el));
        }
        addClass(list, this.clsFit);
        const close = $("[z-close]", $el);
      ...
      events: [
        ...
        },
        {
          ...
          async handler(_, item) {
            ...
            this.setItem(item, "<span z-spinner z-inverse></span>");
            if (!src) {
              return;
            }
            let matches2;
            const iframeAttrs = {
              ...
              "z-responsive": "",
              "z-video": Boolean(this.videoAutoplay)
            };
      ...
      methods: {
        ...
        setError(item) {
          this.setItem(item, '<span z-icon="icon: bolt; ratio: 2" z-inverse></span>');
        },
        showControls() {
          clearTimeout(this.controlsTimer);
          this.controlsTimer = this.delayControls && setTimeout(this.hideControls, this.delayControls);
          addClass(this.$el, "z-active", "z-transition-active");
        },
        hideControls() {
          removeClass(this.$el, "z-active", "z-transition-active");
        }
      }
    };
    ...
    const selDisabled$1 = ".z-disabled *, .z-disabled, [disabled]";
    var lightbox = {
      install: install$3,
      props: { toggle: String },
      data: { toggle: "a" },
    ...
    function install$3(zUIkit, Lightbox) {
      if (!zUIkit.lightboxPanel) {
        zUIkit.component("lightboxPanel", LightboxPanel);
      }
      assign(Lightbox.props, zUIkit.component("lightboxPanel").options.props);
    }
    ...
    var notification = {
      ...
      data: {
        ...
        group: "",
        pos: "top-center",
        clsContainer: "z-notification",
        clsClose: "z-notification-close",
        clsMsg: "z-notification-message"
      },
      install: install$2,
      computed: {
      ...
      created() {
        ...
        this.$mount(
          append(
            container,
            `<div class="${this.clsMsg}${this.status ? ` ${this.clsMsg}-${this.status}` : ""}" role="alert">  <a href class="${this.clsClose}" data-z-close></a>  <div>${this.message}</div>  </div>`
          )
        );
      },
      async connected() {
    ...
    function install$2(zUIkit) {
      zUIkit.notification.closeAll = function(group, immediate) {
        apply(document.body, (el) => {
          const notification = zUIkit.getComponent(el, "notification");
    ...
    function toMedia(value, element) {
      if (isString(value)) {
        if (startsWith(value, "@")) {
          value = toFloat(css(element, `--z-breakpoint-${value.slice(1)}`));
        } else if (isNaN(value)) {
          return value;
        }
      }
    ...
    var slider = {
      ...
      data: {
        center: false,
        sets: false,
        attrItem: "z-slider-item",
        selList: ".z-slider-items",
        selNav: ".z-slider-nav",
        clsContainer: "z-slider-container",
        active: "all",
        Transitioner
      },
      computed: {
    ...
    var slideshow = {
      ...
      data: {
        ...
        minHeight: void 0,
        maxHeight: void 0,
        selList: ".z-slideshow-items",
        attrItem: "z-slideshow-item",
        selNav: ".z-slideshow-nav",
    ...
    var sortable = {
      ...
      data: {
        group: false,
        threshold: 5,
        clsItem: "z-sortable-item",
        clsPlaceholder: "z-sortable-placeholder",
        clsDrag: "z-sortable-drag",
        clsDragState: "z-drag",
        clsBase: "z-sortable",
        clsNoDrag: "z-sortable-nodrag",
        clsEmpty: "z-sortable-empty",
        clsCustom: "",
        handle: false,
        pos: {}
      },
    ...
    var Position = {
      ...
      methods: {
        ...
        getPositionOffset(element = this.$el) {
          return toPx(
            this.offset === false ? css(element, "--z-position-offset") : this.offset,
        ...
        getShiftOffset(element = this.$el) {
          return this.align === "center" ? 0 : toPx(
            css(element, "--z-position-shift-offset"),
            this.axis === "y" ? "width" : "height",
            element
          ) * (includes(["left", "top"], this.align) ? 1 : -1);
        },
        getViewportOffset(element) {
          return toPx(css(element, "--z-position-viewport-offset"));
        }
      }
    };
    ...
    var tooltip = {
      ...
      data: {
        pos: "top",
        animation: ["z-animation-scale-up"],
        duration: 100,
        cls: "z-active"
      },
      connected() {
      ...
      methods: {
        ...
        async _show(title, id) {
          this.tooltip = append(
            this.container,
            `<div id="${id}" class="z-${this.$options.name}" role="tooltip">  <div class="z-${this.$options.name}-inner">${title}</div>  </div>`
          );
    ...
    var Accordion = {
      ...
      data: {
        ...
        multiple: false,
        clsOpen: "z-open",
        toggle: ".z-accordion-title",
        content: ".z-accordion-content",
        offset: 0
      },
      computed: {
    ...
    var drop = {
      ...
      data: {
        ...
        animateOut: false,
        bgScroll: true,
        animation: ["z-animation-fade"],
        cls: "z-open",
        container: false,
        closeOnScroll: false,
        selClose: ".z-drop-close"
      },
      computed: {
      ...
      methods: {
        ...
        isDelaying() {
          return [this.$el, ...$$(".z-drop", this.$el)].some((el) => this.tracker.movesTo(el));
        },
        position() {
          const restoreScrollPosition = storeScrollPosition(this.$el);
          removeClass(this.$el, "z-drop-stack");
          css(this.$el, this._style);
          this.$el.hidden = true;
    ...
    var grid = {
      ...
      data: {
        margin: "z-grid-margin",
        clsStack: "z-grid-stack",
        masonry: false,
        parallax: 0,
        parallaxStart: 0,
        parallaxEnd: 0,
      ...
      connected() {
        this.masonry && addClass(this.$el, "z-flex-top", "z-flex-wrap-top");
      },
    ...
    var accordionIcon = "<svg width=\"13\" height=\"13\" viewBox=\"0 0 13 13\"><style>.z-accordion-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-out;transition-property:transform, opacity;transform-origin:center}[aria-expanded=&quot;true&quot;] .z-accordion-icon svg&gt;.line-1{transform:rotate(-45deg);opacity:0}[aria-expanded=&quot;true&quot;] .z-accordion-icon svg&gt;.line-2{transform:rotate(90deg)}</style><rect width=\"13\" height=\"1\" fill=\"#000\" x=\"0\" y=\"6\" class=\"line-1\"/><rect width=\"1\" height=\"13\" fill=\"#000\" x=\"6\" y=\"0\" class=\"line-2\"/></svg>";
    ...
    var navbarToggleIcon = "<svg width=\"20\" height=\"20\" viewBox=\"0 0 20 20\"><style>.z-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.z-navbar-toggle-icon svg&gt;.line-3{opacity:0}[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-3{opacity:1}[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-2,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-2{transform:rotate(45deg)}[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-3{transform:rotate(-45deg)}[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-4{opacity:0}[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-1{transform:translateY(6px) scaleX(0)}[aria-expanded=&quot;true&quot;].z-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.z-navbar-toggle-icon svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width=\"20\" height=\"2\" y=\"3\" class=\"line-1\"/><rect width=\"20\" height=\"2\" y=\"9\" class=\"line-2\"/><rect width=\"20\" height=\"2\" y=\"9\" class=\"line-3\"/><rect width=\"20\" height=\"2\" y=\"15\" class=\"line-4\"/></svg>";
    ...
    const NavParentIcon = {
      ...
      beforeConnect() {
        ...
        this.icon = this.$el.closest(".z-nav-primary") ? `${icon}-large` : icon;
      }
    };
    const Search = {
      extends: IconComponent,
      ...
      beforeConnect() {
        const isToggle = hasClass(this.$el, "z-search-toggle") || hasClass(this.$el, "z-navbar-toggle");
        this.icon = isToggle ? "search-toggle-icon" : hasClass(this.$el, "z-search-icon") && this.$el.closest(".z-search-large") ? "search-large" : this.$el.closest(".z-search-medium") ? "search-medium" : this.$props.icon;
    ...
    const Slidenav = {
      ...
      beforeConnect() {
        addClass(this.$el, "z-slidenav");
        const icon = this.$props.icon;
        this.icon = hasClass(this.$el, "z-slidenav-large") ? `${icon}-large` : icon;
      }
    };
    ...
    const Close = {
      ...
      i18n: { label: "Close" },
      beforeConnect() {
        this.icon = `close-${hasClass(this.$el, "z-close-large") ? "large" : "icon"}`;
      }
    };
    const Marker = {
      extends: ButtonComponent,
    ...
    const parsed = {};
    function install$1(zUIkit) {
      zUIkit.icon.add = (name, svg) => {
        const added = isString(name) ? { [name]: svg } : name;
        each(added, (svg2, name2) => {
          icons[name2] = svg2;
          delete parsed[name2];
        });
        if (zUIkit._initialized) {
          apply(
            document.body,
            (el) => each(zUIkit.getComponents(el), (cmp) => {
      ...
      update: {
        read() {
          ...
          for (const target of toNodes(this.target)) {
            ...
            if (color !== false) {
              replaceClass(target, "z-light z-dark", color);
            }
          }
        }
      }
    ...
    function findTargetColor(target) {
      ...
      for (const percent of [0.25, 0.5, 0.75]) {
        ...
        for (const element of elements) {
          ...
          const color = css(element, "--z-inverse");
          if (color) {
            if (color === last) {
              return `z-${color}`;
            }
    ...
    var leader = {
      ...
      data: {
        fill: "",
        clsWrapper: "z-leader-fill",
        clsHide: "z-leader-hide",
        attrFill: "data-fill"
      },
      computed: {
        fill: ({ fill }, $el) => fill || css($el, "--z-leader-fill-content")
      },
      connected() {
    ...
    var modal = {
      ...
      mixins: [Modal],
      data: {
        clsPage: "z-modal-page",
        selPanel: ".z-modal-dialog",
        selClose: '[class*="z-modal-close"]'
      },
      events: [
        {
        ...
        },
        {
          ...
          self: true,
          handler() {
            if (hasClass(this.panel, "z-margin-auto-vertical")) {
              addClass(this.$el, "z-flex");
            } else {
    ...
    function install({ modal }) {
      modal.dialog = function(content, options) {
        const dialog = modal($(`<div><div class="z-modal-dialog">${content}</div></div>`), {
          stack: true,
          role: "alertdialog",
          ...options
        });
      ...
      modal.alert = function(message, options) {
        return openDialog(
          ({ i18n }) => `<div class="z-modal-body">${isString(message) ? message : html(message)}</div>  <div class="z-modal-footer z-text-right">  <button class="z-button z-button-primary z-modal-close" type="button" autofocus>${i18n.ok}</button>  </div>`,
          options
        );
      };
      modal.confirm = function(message, options) {
        return openDialog(
          ({ i18n }) => `<form>  <div class="z-modal-body">${isString(message) ? message : html(message)}</div>  <div class="z-modal-footer z-text-right">  <button class="z-button z-button-default z-modal-close" type="button">${i18n.cancel}</button>  <button class="z-button z-button-primary" autofocus>${i18n.ok}</button>  </div>  </form>`,
          options,
          () => Promise.reject()
        );
      };
      modal.prompt = function(message, value, options) {
        const promise = openDialog(
          ({ i18n }) => `<form class="z-form-stacked">  <div class="z-modal-body">  <label>${isString(message) ? message : html(message)}</label>  <input class="z-input" autofocus>  </div>  <div class="z-modal-footer z-text-right">  <button class="z-button z-button-default z-modal-close" type="button">${i18n.cancel}</button>  <button class="z-button z-button-primary">${i18n.ok}</button>  </div>  </form>`,
          options,
          () => null,
          () => input.value
        );
    ...
    const clsNavbarTransparent = "z-navbar-transparent";
    var navbar = {
      extends: Dropnav,
      props: {
      ...
      data: {
        ...
        autoUpdate: false,
        delayShow: 200,
        clsDrop: "z-navbar-dropdown",
        selNavItem: ".z-navbar-nav > li > a,a.z-navbar-item,button.z-navbar-item,.z-navbar-item a,.z-navbar-item button,.z-navbar-toggle",
        // Simplify with :where() selector once browser target is Safari 14+
        dropbarTransparentMode: false
      },
      computed: {
        navbarContainer: (_, $el) => $el.closest(".z-navbar-container")
      },
      watch: {
        items() {
          const justify = hasClass(this.$el, "z-navbar-justify");
          const containers = $$(".z-navbar-nav, .z-navbar-left, .z-navbar-right", this.$el);
          for (const container of containers) {
            const items = justify ? $$(".z-navbar-nav > li > a, .z-navbar-item, .z-navbar-toggle", container).length : "";
    ...
    var offcanvas = {
      ...
      data: {
        ...
        flip: false,
        overlay: false,
        clsPage: "z-offcanvas-page",
        clsContainer: "z-offcanvas-container",
        selPanel: ".z-offcanvas-bar",
        clsFlip: "z-offcanvas-flip",
        clsContainerAnimation: "z-offcanvas-container-animation",
        clsSidebarAnimation: "z-offcanvas-bar-animation",
        clsMode: "z-offcanvas",
        clsOverlay: "z-offcanvas-overlay",
        selClose: ".z-offcanvas-close",
        container: false,
        swiping: true
      },
      computed: {
    ...
    var overflowAuto = {
      ...
      data: {
        selContainer: ".z-modal",
        selContent: ".z-modal-dialog",
        minHeight: 150
      },
      computed: {
        ...
        write({ overflow }) {
          for (let i = 0; i < 2; i++) {
            ...
            if (!overflow[i - 1]) {
              ...
              css(this.$el, {
                "--z-overflow-fade-start-opacity": toValue(percent),
                "--z-overflow-fade-end-opacity": toValue(1 - percent)
              });
            }
          }
        },
    ...
    var responsive = {
      props: ["width", "height"],
      connected() {
        addClass(this.$el, "z-responsive-width");
    ...
    const clsInView = "z-scrollspy-inview";
    var scrollspy = {
      args: "cls",
      props: {
        cls: String,
      ...
      observe: intersection({
        ...
        handler(records) {
          ...
          for (const { target: el, isIntersecting } of records) {
            if (!elements.has(el)) {
              elements.set(el, {
                cls: data(el, "z-scrollspy-class") || this.cls
              });
            }
      ...
      methods: {
        toggle(el, inview) {
          ...
          let match;
          if (match = state.cls.match(/\bz-animation-[\w-]+/g)) {
    ...
    var sticky = {
      ...
      data: {
        ...
        clsActive: "z-active",
        clsInactive: "",
        clsFixed: "z-sticky-fixed",
        clsBelow: "z-sticky-below",
        selTarget: "",
        showOnUp: false,
        targetOffset: false
      },
      ...
      connected() {
        ...
        this.placeholder = $("+ .z-sticky-placeholder", this.$el) || $('<div class="z-sticky-placeholder"></div>');
        this.isFixed = false;
      ...
      update: [
        {
          read({ height: height$1, width, margin, sticky }, types) {
            ...
            const topOffset = offset(referenceElement).top - // offset possible `transform: translateY` animation 'z-animation-slide-top' while hiding
          ...
          write(data, types) {
            ...
            if (this.inactive || scroll2 < start || this.showOnUp && (scroll2 <= start || dir === "down" && isScrollUpdate || dir === "up" && !this.isFixed && !below)) {
              ...
              if (this.animation && below) {
                if (hasClass(this.$el, "z-animation-leave")) {
                  return;
                }
    ...
    const clsTransitionDisable = "z-transition-disable";
    ...
    function applyAttributes(el) {
      const { $el } = this;
      addClass(el, attr($el, "class"), "z-svg");
    ...
    function applyAnimation(el) {
      const length = getMaxPathLength(el);
      if (length) {
        css(el, "--z-animation-stroke", length);
      }
    }

    const selDisabled = ".z-disabled *, .z-disabled, [disabled]";
    var Switcher = {
      mixins: [Togglable],
      args: "connect",
      props: {
    ...
    var tab = {
      ...
      data: {
        media: 960,
        attrItem: "z-tab-item",
        selVertical: ".z-tab-left,.z-tab-right"
      },
      connected() {
        const cls = hasClass(this.$el, "z-tab-left") ? "z-tab-left" : hasClass(this.$el, "z-tab-right") ? "z-tab-right" : false;
        if (cls) {
